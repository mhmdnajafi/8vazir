...
class Gentic():
    ...
    def txt(self,path,data):
        with open('{}/result{}{}.txt'.format(path,self.runner,self.population),'w') as result:
            result.write('solution  {} Queen ({} * {})\n Information:   \n 1-Population:  {} \n 2-Crossover:  {} \n 3-Mutation :  {} \n 4-Run:  {}\n\n '.format(self.GA,self.GA,self.GA,self.population,self.crossover_percent,self.mutation_percent,self.runner))
            for answer in data:
                result.write(str(answer)+'\n')
